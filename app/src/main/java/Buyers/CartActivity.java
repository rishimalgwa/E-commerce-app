...
public class CartActivity extends AppCompatActivity {
    ...
    private TextView textTotalPrice , txtMsg1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                textTotalPrice.setText("Total Price = ₹" + String.valueOf(totalPrice));
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Cart> options =
                ...
                .child(Prevalent.currentOnlineUser.getPhone()).child("Product"),Cart.class).build();
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (shippedState.equals("shipped")){
                        textTotalPrice.setText("Dear "+username+"\n order is shipped Successfully");
                        ...
                        textTotalPrice.setText("Shipping state = Not Shipped");
                        recyclerView.setVisibility(View.GONE);
